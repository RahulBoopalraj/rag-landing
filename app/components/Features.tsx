    ...
    <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[80px] ">
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          Empower your business with conversational AI to build lasting relationships, increase engagement, 
          and drive loyalty. Let the technology handle customer interactions while you focus on growth 
